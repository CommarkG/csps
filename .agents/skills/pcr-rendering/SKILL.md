...
P-OP-003 PCR + B_PCR_FOR_DECISIONS (S005 turn 5 user directive: "create mechanical solutions making you present pros cons and recommendations"). Full text: [packages/principles/principles.yaml#P-OP-003](../../../packages/principles/principles.yaml). Mirrors [packages/skills/pcr/SKILL.md](../../../packages/skills/pcr/SKILL.md) at Codex skill auto-load location.
