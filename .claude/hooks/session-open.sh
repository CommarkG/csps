...
const context = [
  ...
  '  I AM: [the DRAFTER — Sonnet when Sonnet writes; Opus when Opus writes. NOT "Governor" unless Governor personally authored]',
  ...
  '',
  'RULE 12 — Governor Instruction Completeness (CONSTITUTIONAL — B_ZERO_NAVIGATION_FOR_GOVERNOR):',
  ...
  '  This applies to OPTIMAL NEXT STEP blocks. "Paste from sonnet-turn.md" = violation.',
  ...
  '',
  '(Communication protocol rules are at TOP of this context block — see above)',
  '',
