...
const context = [
  ...
  '',
  'SESSION NAMING CONVENTION (so tabs are identifiable):',
  '  New chat first message = the permanent tab name. Format:',
  '  OPUS-S[NNN]     → Opus Advisor session (strategic, no code)',
  '  SONNET-S[NNN]   → Sonnet Builder session (implementation)',
  '  HAIKU-S[NNN]    → Haiku Scanner session (subagent scanning)',
  '  Example: first message "SONNET-S022" makes the tab named "SONNET-S022"',
  '  Context briefs: tools/council/opus-1-context.md | sonnet-1-context.md | haiku-1-context.md',
  '',
