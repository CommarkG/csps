...
const context = [
  ...
  '  SONNET DIRECTIVE (Opus drafts, Governor relays):',
  ...
  '  SONNET SROF TO OPUS (Sonnet drafts, Governor relays):',
  ...
  '  "I AM" = the DRAFTER, not the Governor unless Governor personally authored it.',
  '  Governor relays without changing "I AM".',
