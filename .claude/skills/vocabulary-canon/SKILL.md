...
trigger_criteria:
  ...
  classification_class: ["question","proposal"]
  content_signals: ["name","naming","frontmatter","enum","vocabular","rename","glossary"]
  notes: "Naming + enum decisions — fast-path invocation since naming has low blast radius"
---
