...
<!-- Regenerated after every clean verify pass. Last: 2026-06-28 08:36 -->
<!-- Source: git HEAD=b261e1d4a58a | verify: exit_code=0 | blocking=0 | validators=237 -->
...
HEAD = b261e1d4a58a ([S089] relay round-10: FVC use/park applied + UX build queue (relabel AGENTS + FVC to 7 pages + Step-2 SAGD router))
branch: main
verify: exit_code=0 | blocking=0 | validators=237 — stable

OPEN PARKS: ~92 items in park-register.yaml (see tools/data/park-register.yaml)
...
- Generated: 2026-06-28 08:36
- HEAD: b261e1d4a58a4327b0b8b05bc90122ef79358de9
- Session: S089
