...
<!-- Regenerated after every clean verify pass. Last: 2026-07-25 22:51 -->
<!-- Source: git HEAD=a0697ba152b9 | verify: exit_code=0 | blocking=0 | validators=239 -->
...
HEAD = a0697ba152b9 ([S089] dna-guardian: Graphify intake — ALIGNED-WITH-TRANSLATION (CLI-only, --code-only, quarantined output))
branch: main
verify: exit_code=0 | blocking=0 | validators=239 — stable

OPEN PARKS: ~104 items in park-register.yaml (see tools/data/park-register.yaml)
...
- Generated: 2026-07-25 22:51
- HEAD: a0697ba152b9b8e1a8e72c6a7b637c26829bb305
- Session: S089
