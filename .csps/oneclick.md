...
<!-- Regenerated after every clean verify pass. Last: 2026-06-28 04:43 -->
<!-- Source: git HEAD=62077e8aa8d6 | verify: exit_code=0 | blocking=0 | validators=236 -->
...
HEAD = 62077e8aa8d6 ([S089] feat: First Viewport Contract (FVC) — full governance system (5 sources + CSPS-original) SACRED-EDIT-APPROVED:add FVC Gate + WHAT-WAS-NOT-INCLUDED hard-NOs to AGENTS.md — critical UX governance gates)
branch: main
verify: exit_code=0 | blocking=0 | validators=236 — stable

OPEN PARKS: ~91 items in park-register.yaml (see tools/data/park-register.yaml)
...
- Generated: 2026-06-28 04:43
- HEAD: 62077e8aa8d6f5af2c9cbe3f556758ba12910b56
- Session: S089
- Verify: exit_code=0 | blocking=0 | validators=236
- Open parks: ~91
