// apps/budget-planner/src/app/dashboard/page.tsx
// @csps-enforces P-META-022 (threshold gate — no dashboard without crystallized intent)
// Budget Planner dashboard — balance overview, categories, recent transactions.
// Accessible at /dashboard. Root / redirects here.
