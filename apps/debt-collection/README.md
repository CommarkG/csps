---
id: csps.apps.debt-collection
name: debt-collection
description: "Debt Collection — first CSPS wet trial app. Helps small business owners collect money owed without awkward confrontation. Forked from apps/template/. S060 PROTO-K."
type: app
...
version: "0.1.0"
session: S059
context_question: "Is the tenant isolation active? Does the core loop (problem statement → invoice → tracking → reminder) work end-to-end for one real user?"
---

# Debt Collection App

**CSPS first wet trial app — S060 PROTO-K.**
Forked from apps/template/. Governor-validated use case.
