---
id: csps.apps.voice-sorting.readme
name: voice-sorting-readme
description: "APP-001 Voice Sorting App — cognitive-offload-professional persona, E1 build"
version: 1.0
owner: group:finky
...
# APP-001 — Voice Sorting App

**Persona:** Alex (cognitive-offload-professional)
**Core value:** "The bridge between raw thinking and organized action"

## What it is

A voice-first capture app for professionals who are cognitively overloaded.
Speak what's on your mind. The app captures, structures, and holds it until you're ready.

## First value moment

Day 7 weekly digest: "Here's everything you captured this week, sorted by what still needs attention."
Not Day 1 notification. The first value is the digest, not the instant ping.

## Market position

See: `tools/vault/concepts/APP-001-CONTEXT-CARRIERS.md`

## Kill condition

Kill if after 14 days with 5 real users: reliability_score < 0.70 + >3 corrections/session, OR voice fails in >40% of moving-vehicle clips.
