...
- pnpm verify: **28 active validators PASS** (was 9)
...
2. **Verify state**: `pnpm verify --skip-install` exit_code 0; 53 principles / 17 templates / 130 slices / **28** active validators; 0 frontmatter warnings; 0 AAP warnings
