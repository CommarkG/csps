---
id: csps.governance.ai-council-edge-case-protocols
name: AI-COUNCIL-EDGE-CASE-PROTOCOLS
description: >
  Edge case protocols for the CSPS AI council. Covers: context limit detection
  and response, compaction pre-flight and post-compact alignment, active agent
  harvesting before tab change, new tab creation handshake, and multi-agent
  coordination on tab boundary. Companion to AI-COUNCIL-COMMUNICATION-SPINE.md.
...
links:
  - { rel: spine, href: ./AI-COUNCIL-COMMUNICATION-SPINE.md }
  - { rel: rules, href: ../../../tools/council/communication-protocol-shared.md }
  - { rel: protocol, href: ../../../tools/council/PROTOCOL.md }
  - { rel: validator, href: ../../../tools/validators/validate-session-close-completeness.mjs }
---
