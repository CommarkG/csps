...
| [operating-principles.md](operating-principles.md) | 🟢 v1.5 | The 7 operating principles — Reuse-first, FWWS, PCR, Batched execution — with industry lineage and per-layer enforcer mapping |
