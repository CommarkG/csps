...
enforcement_trio:
  t1:
    tier: hook
    path: ".claude/hooks/post-stop-pnpm-verify.sh"
    status: active
  t2:
    tier: validator
    path: null
  ...
  t3:
    ...
    status: active
  exempt_reason: "T2 validator planned for S063. T1 (post-stop-pnpm-verify.sh — CRITICAL hook in verify roster) and T3 are active."
---
