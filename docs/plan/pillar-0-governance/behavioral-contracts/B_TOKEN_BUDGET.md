...
enforcement_trio:
  ...
  t3:
    tier: memory+schema
    path: "session-open injection + AGENTS.md hard-NO + load_mode frontmatter field"
    status: active
  promoted_at: S084
  reason: "B_TOKEN_BUDGET was T3-only (advisory). R9+R10 added; T1+T2 now active. PROTO-S084-TEG."
---
[//]: # (B_TOKEN_BUDGET.md)
