...
| OPEN-043 | nav.js extraction: extract PAGES data object to page-data.js (C5 gap — nav.js at 529+ lines). Separates rendering logic from page data for maintainability. | S040 | pending S041 playground | nav.js clarity | none yet |
