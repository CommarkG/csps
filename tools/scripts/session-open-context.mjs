...
const context = [
  ...
  '╠══════════════════════════════════════════════════════════════════╣',
  `║  CONFIGURED MODEL : ${configuredModelShort.padEnd(42)}║`,
  `║  MODEL ID         : ${configuredModel.padEnd(42)}║`,
  '║                                                                  ║',
  '║  MANDATORY: Your FIRST response in this tab must output ONLY:   ║',
  '║    ACTIVE MODEL: [your actual model name]                        ║',
  '║    ROLE: [Sonnet=builder | Opus=director]                        ║',
  '║    Awaiting Governor confirmation before I proceed.              ║',
  '║                                                                  ║',
  '║  If your actual model ≠ configured model above → say so.        ║',
  '║  Governor replies "confirmed" → proceed with full context.       ║',
  '║  Governor replies "wrong model" → stop, Governor switches model. ║',
  '╚══════════════════════════════════════════════════════════════════╝',
  '',
  '╔══════════════════════════════════════════════════════════════════╗',
