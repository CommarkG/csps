...
// @core-seed: TEMPLATE_COMPLIANCE_BLOCKING | plan: deprecated-S044 | grows-to: DEPRECATED — template compliance now via template-registry.md + validate-template-grade.mjs (active). Blocking upgrade deferred S045+. | target: S044 | closed: S044 OPEN-058
